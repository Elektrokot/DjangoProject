...
# class Student(models.Model):
    ...
    # created_at = models.DateTimeField(auto_now_add=True)
    # image = models.ImageField(upload_to='photos/', verbose_name='Фотография', null=True, blank=True)
    # group = models.ForeignKey('StudentGroup', on_delete=models.DO_NOTHING, related_name='students', null=True, blank=True)
